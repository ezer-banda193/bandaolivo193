			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Vacaciones</span> - Agregar</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="editor_ckeditor.html" class="breadcrumb-item">Vacaciones</a>
			...
			<div class="content">
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<form action="#">
							<fieldset class="mb-3">
								<legend class="text-uppercase font-size-sm font-weight-bold">Introducir Datos</legend>
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Periodo</label>
									<div class="col-lg-10">
										<input type="text" class="form-control">
									</div>
								</div>
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Autorizado</label>
									<div class="col-lg-10">
										<input type="text" class="form-control">
									</div>
								</div>
							...
							<fieldset class="mb-3">
								...
								/-->
		                        <div class="form-group row">
		                        	<label class="col-form-label col-lg-2">Jefe de Area</label>
		                        	<div class="col-lg-10">
			                            <select class="form-control">
			                                <option value="opt1"> - Selecciona - </option>
			                                <option value="opt2">Mario Rodriguez</option>
			                                <option value="opt3">Jorge Hernandez</option>
		                      ...
		                      <fieldset class="mb-3">
		                        ...
		                        <div class="form-group row">
		                        	...
		                        	<div class="col-lg-10">
			                            <select class="form-control">
			                                <option value="opt1"> - Selecciona - </option>
			                                <option value="opt2">Programación Web</option>
			                                <option value="opt3">Tecnologias de la Información</option>
			                                <option value="opt3">Programación de Objetos</option>
