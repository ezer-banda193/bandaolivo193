			...
			<div class="sidebar-content">
				...
				<div class="card card-sidebar-mobile">
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<!-- Forms -->
						<li class="nav-item-header"><div class="text-uppercase font-size-xs line-height-xs">Tables</div> <i class="icon-menu" title="Forms"></i></li>
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Form components">
								...
								/-->
								<li class="nav-item"><a href="form_validation.html" class="nav-link active">Departamento</a></li>
								<!--
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Departamento</span> - Empleados</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<span class="breadcrumb-item active">Departamento</span>
						</div>
...
/-->
								...
								<!-- Select2 select -->
								<div class="form-group row">
									<label class="col-form-label col-lg-3">Departamento <span class="text-danger">*</span></label>
									<div class="col-lg-9">
										<select name="select2" data-placeholder="Select a Departament..." class="form-control form-control-select2" required data-fouc>
											<option></option>
											<optgroup label="Area de Trabajo">
												<option value="AK">Programación Web</option>
												<option value="HI">Tecnologias de la Información</option>
												<option value="HI">Programación de Objetos</option>
											</optgroup>
										</select>
									</div>
								</div>
					...
					<div class="table-responsive">
						<table class="table">
							...
							<tbody>
								<tr>
									<td>1
		                    	<p><button type="button" class="btn btn-danger"><i class="icon-comment-discussion mr-2"></i> Eliminar</button></p>
		                    	<p><button type="button" class="btn btn-success btn-sm"><i class="icon-comment-discussion mr-2"></i>Guardar</button></p>
									</td>

									<td>Ezer</td>
									<td>Banda</td>
									<td>1930230</td>
                                    <td>Programación Web</th>
                                    <td>Completa</th>
                                    <td>Credito</th>
                                    <td>30</td>
								</tr>
