	...
	<div class="page-content">
		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Listar - Tabla</span> -- Tutorias</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="extra_pnotify.html" class="breadcrumb-item">Extra</a>
			...
			<div class="content">
						...
						<table class="table">
							...
							<tbody>
								<tr>
									...
									<td>19/10/19</td>
									<td>Dominio</td>
									<td><a href="#" class="list-icons-item" data-toggle="modal" data-target="#remove_modal1"><i class="icon-list-unordered"></i></td>
									<td><a href="#" class="list-icons-item" data-toggle="modal" data-target="#remove_modal"><i class="icon-trash"></i></td>								
								</tr>
								<tr>
									<td>2</td>
									<td>1930232</td>
				...
				<!-- /basic table -->
			    <!-- Remove modal -->
				<div id="remove_modal1" class="modal fade" role="dialog">
