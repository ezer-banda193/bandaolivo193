					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Extra components">
								<li class="nav-item"><a href="extra_pnotify.php" class="nav-link">Listar</a></li>
								...
								<li class="nav-item-divider"></li>/-->
								<li class="nav-item"><a href="extra_sliders_noui.php" class="nav-link active">Editar</a></li>
								<!--
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="extra_sliders_noui.html" class="breadcrumb-item">Extra</a>
			...
			<div class="content">
				...
				<div class="row">
					...
					<div class="col-md-4">
						<div class="card card-body border-top-primary">
							<div class="text-center">
								<h6 class="mb-0 font-weight-semibold">Sizes. Solid handle</h6>
								<p class="mb-3 text-muted">Using <code>noui-slider-solid</code> class</p>
							</div>

							<div class="noui-slider-primary noui-slider-solid noui-slider-lg noui-height-helper" id="slider-solid-lg" style="margin-bottom: 30px;" data-fouc></div>
							<div class="noui-slider-danger noui-slider-solid noui-height-helper" id="slider-solid-md" style="margin-bottom: 30px;" data-fouc></div>
							<div class="noui-slider-success noui-slider-solid noui-slider-sm mb-1 noui-height-helper" id="slider-solid-sm" data-fouc></div>
						</div>
					</div>
