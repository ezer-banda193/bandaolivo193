					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Form components">
								...
								<li class="nav-item"><a href="form_checkboxes_radios.html" class="nav-link active">Agregar</a></li>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Agregar</span> - Empleados</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="form_checkboxes_radios.html" class="breadcrumb-item">Forms</a>
					...
					<div class="card-body">
						...
						<form action="#">
							<fieldset class="mb-3">
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Cuenta</label>
									<div class="col-lg-10">
								...
								/-->
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Numero Cuenta</label>
									<div class="col-lg-10">
