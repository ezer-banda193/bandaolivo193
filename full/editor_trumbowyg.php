					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Text editors">
								...
								<li class="nav-item"><a href="editor_trumbowyg.html" class="nav-link active">Editar</a></li>
								<!--
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Vacaciones</span> - Editar</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="editor_trumbowyg.html" class="breadcrumb-item">Vacaciones</a>
					...
					<div class="col-md-6">
						<div class="card">
							<div class="card-header header-elements-inline">
								<h5 class="card-title">Selecciona Empleado</h5>
							...
							<div class="card-body">
								<div class="form-group">
									...
									<select class="form-control select-search" data-fouc>
										<optgroup label="¿A quien Buscas?">
											<option value="AZ">Ezer Manuel Banda Olivo</option>
											<option value="CO">Karen Lizeth Garcia Rivera</option>
											<option value="ID">Adair Eliseo Rojas Oaxaca</option>
											<option value="WY">Angel Uriel Hernandez Cepeda</option>
									</select>
								</div>
				                <div class="form-group row">
									<label class="col-form-label col-lg-2">Nombre Nuevo</label>
									<div class="col-lg-10">
										<input type="text" class="form-control">
									</div>
								</div>
								<div class="form-group">
									<label class="d-block">Clave</label>
									<select class="form-control select-fixed-single" data-fouc>
										<optgroup label="Matricula">
											<option value="AZ">1930230</option>
											<option value="CO">1920243</option>
											<option value="ID">1932893</option>
											<option value="WY">1934234</option>
										</optgroup>
									</select>
								</div>
				                <div class="form-group row">
									<label class="col-form-label col-lg-2">Clave Nueva</label>
									<div class="col-lg-10">
										<input type="text" class="form-control">
									</div>
								</div>
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Fecha de Culminación</label>
									<div class="col-lg-10">
										<input type="text" class="form-control">
									</div>
								</div>
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Situación</label>
									<div class="col-lg-10">
                                   </div>
                                </div>   
									<div class="form-group row">
									...
									<div class="col-lg-10">
										<textarea rows="3" cols="3" class="form-control" placeholder="Describe"></textarea>
									</div>
								</div>								
								<!--
								<div class="form-group">
