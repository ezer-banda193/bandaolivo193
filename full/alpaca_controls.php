			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Empresas</span> - Editar</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="alpaca_controls.html" class="breadcrumb-item">Empresas</a>
					...
					<div class="col-md-6">
						<div class="card">
							<div class="card-header header-elements-inline">
								...
								<div class="form-group">
									...
									<select class="form-control select" data-dropdown-css-class="bg-teal-400" data-fouc>
										<optgroup href="alpaca_advanced.html" label="Main content">
											<option value="AZ">Telmex</option>
											<option value="CO">Uber</option>
											<option value="ID">Walmert</option>
											<option value="WY">Banorte</option>
										</optgroup>
									</select>
								</div>							
							...
							<div class="card-body">
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Numero de sucursales</label>
									<div class="col-lg-10">
										<input type="text" class="form-control">
									</div>
								</div>
								...
								<!--
									...
									<select class="form-control select-search" data-fouc>
										<optgroup label="¿A quien Buscas?">
											<option value="AZ">Ezer</option>
											<option value="CO">Karen</option>
											<option value="ID">Adair</option>
											<option value="WY">Angel</option>
										</optgroup>
										<optgroup label="Campo">
											<option value="AL">Programación</option>
											<option value="AR">TIC</option>
											<option value="KS">Programación Objetos</option>
								...
								<div class="form-group">
									...
									<select class="form-control select-search" data-fouc>
										<optgroup>
											<option value="AZ">Cd. victoria</option>
											<option value="CO">Cd. Mante</option>
											<option value="ID">Tula</option>
											<option value="WY">Tampico</option>
										</optgroup>
									</select>
								</div>
								<!--
